...
@push('css')
     ...
     <link href="{{asset('adminCork/plugins/animate/animate.css')}}" rel="stylesheet" type="text/css" />
     <!-- END PAGE LEVEL PLUGINS -->
     
     <!--  BEGIN CUSTOM STYLE FILE  -->
     <link href="{{asset('adminCork/assets/css/scrollspyNav.css')}}" rel="stylesheet" type="text/css" />
     <link href="{{asset('adminCork/assets/css/components/custom-modal.css')}}" rel="stylesheet" type="text/css" />
